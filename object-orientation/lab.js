...
let dog = {
  name : 'Toby',
  color : 'grayish with black spots',
  age : 12,
  goodestBoy : true,
}
...
/*
  ...
  then another key named 'show' with the value being your favorite 
  show.
*/

favoriteThings.car = 'truck'
favoriteThings.show = 'whose line'
...
favoriteThings.food = 'Chicken nuggets (that\'s a lie it\'s still chips)'
favoriteThings.book = 'You\'re a wiz wiz, Harry'
...
/*
  In the function below named greeting, it is receiving an object as
   a parameter. 
  Use object destructuring to save the object properties to new 
  variables. 
...
/*
  ...
  That object will have 4 properties named utah, california, texas 
  and arizona.
  The property values will be numbers.
  Use object destructuring to save the property values to new 
  variables.
...
let toby = new Cat('Toby', 6, 'orange')
...
let hermione = new Wizard('Hermione', '14', 'wingaaaadrium liviosa')
hermione.castSpell()
...
class Phone{
  contructor(brand, model, storage, color, price){
    this.brand = brand;
    this.model = model;
...
let phone1 = new Phone ('apple', 'iphone X', 30, 'black', 10000000)
let phone2 = new Phone ('samsung', 'galaxy', 40, 'grey', 200000000 )
let phone3 = new Phone ('google', 'pixel', 50, 'silver', 300000000)
...
/*
  ...
  Print the value of that phone's sell property to make sure it's been 
  changed to true
*/
...
//Print helensInfo to see what it looks like, there should be no repeating 
//properties.
...
let myFirstVehicle = new Vehichle(6, 'black', 170000)
...
let myFirstMotorcycle = new Motorcycle(8, 'lilac', 1500, 'harley davidson', 'true')
...
/*
  ...
  Write a class called Boat that *extends* the Vehicle class. 
  The constructor should take in
  all the same arguments as Vehicle plus 3 new ones: 
  name (boats gotta have cool names), type (ski boat, yacht, etc), 
  and isSeaworthy.
...
class Boat extends Vehichle{
  ...
  checkSeaworthiness(){
    ...
    }else{`You need to get your ${this.type} in shape!`}
  }
...
let myFirstBoat = new Boat(15, 'sparkly', 1500, 'princess of genovia', 'fast boat', false)
